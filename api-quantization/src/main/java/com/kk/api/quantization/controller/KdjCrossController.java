 ...
 * @since 2021-12-25
 */
 @Api(value = "/quantization/api/v1/kdj_cross",tags = "kdj交叉点")
@ResponseBody
@RestController
@RequestMapping("/quantization/api/v1/kdj_cross")
public class KdjCrossController {

    @Resource
    public IKdjCrossService service;
    ...
    public ApiResult< PageResult<KdjCross> > getPageResult(@Valid @RequestBody BasePage vo)   {
