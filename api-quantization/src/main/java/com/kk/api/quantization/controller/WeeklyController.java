 ...
 * @since 2021-12-25
 */
 @Api(value = "/quantization/api/v1/weekly",tags = "个股周线行情")
@ResponseBody
@RestController
@RequestMapping("/quantization/api/v1/weekly")
public class WeeklyController {

    @Resource
    public IWeeklyService service;
    ...
    public ApiResult< PageResult<Weekly> > getPageResult(@Valid @RequestBody BasePage vo)   {
