...
public class DailyController {
    ...
    @PostMapping("/get_daily_page_result")
    public ApiResult< PageResult<Daily> > getDailyPageResult(@Valid @RequestBody SearchDailyVo vo)   {

        return new  ApiResult(service.getDailyPageResult(vo));
