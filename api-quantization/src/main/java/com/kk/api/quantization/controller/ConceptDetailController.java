...
public class ConceptDetailController {
    ...
    @Resource
    public IConceptDetailService service;
    ...
    @PostMapping("/get_concept_detail_page_result")
    public ApiResult< PageResult<ConceptDetail> > getPageResult(@Valid @RequestBody BasePage vo)   {

        return new  ApiResult(service.getConceptDetailPageResult(vo));
