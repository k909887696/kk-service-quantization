...
public class SerialNoController {
    ...
    @Resource
    public ISerialNoService service;
    ...
    @PostMapping("/get_serial_no_page_result")
    public ApiResult< PageResult<SerialNo> > getSerialNoPageResult(@Valid @RequestBody BasePage vo)   {

        return new  ApiResult(service.getSerialNoPageResult(vo));
