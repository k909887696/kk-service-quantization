...
public class KdjCrossServiceImpl extends MppServiceImpl<KdjCrossMapper, KdjCross> implements IKdjCrossService {
    ...
    * @return 结果集
    */
    public PageResult<KdjCross>  getPageResult(BasePage vo){

        QueryWrapper<KdjCross> query = new QueryWrapper<>();
        IPage<KdjCross> page = new Page<>(vo.getPageIndex(),vo.getPageSize());

        //这里开始编写查询条件

        page = mapper.selectPage(page,query);
        PageResult<KdjCross>  pageResult = new PageResult<>();
