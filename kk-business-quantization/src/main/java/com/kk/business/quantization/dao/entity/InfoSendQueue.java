 ...
 * @since 2021-12-29
 */
@TableName("info_send_queue")
@Schema(name = "信息发送队列表对象", description = "信息发送队列表")
public class InfoSendQueue implements Serializable {
    ...
    * 接收人，可多个用逗号隔开
    */
    @Schema(description = "接收人，可多个用逗号隔开")
    @TableField("reciver")
    ...
    */
    @Schema(description = "信息类型（email：邮件，sms：短信，gzh：公众号）")
    ...
    * 执行次数（大于30次，不再处理）
    */
    @Schema(description = "执行次数（大于30次，不再处理）")
