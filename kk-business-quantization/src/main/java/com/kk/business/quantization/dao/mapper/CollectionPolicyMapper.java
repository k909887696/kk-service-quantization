...
import com.kk.business.quantization.model.dto.CollectionPolicyListDto;
...
public interface CollectionPolicyMapper extends RootMapper<CollectionPolicy> {
     ...
     * 查询列表
     */
    IPage<CollectionPolicyListDto> selectPageList(IPage page, CollectionPolicyListVo collectionPolicyListVo);
