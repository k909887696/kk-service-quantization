 ...
 * 东方财富概念资金流向息任务执行器
 */
@Service("DfcfConceptMoneyFlowTaskExecutor")
@Slf4j
public class DfcfConceptMoneyFlowTaskExecutor implements ITaskExecutor {
    ...
    public void executeTask(String params) {
        ...
        DfcfConceptMoneyFlowVo vo = (DfcfConceptMoneyFlowVo) JsonUtil.parseObject(params,DfcfConceptMoneyFlowVo.class);
        List<ConceptMoneyFlow> data = new ArrayList<>();
    ...
    public List<CollectionTask> splitTask(CollectionPolicy policy) {
        DfcfConceptMoneyFlowVo vo = (DfcfConceptMoneyFlowVo) JsonUtil.parseObject(policy.getInvokeParams(),DfcfConceptMoneyFlowVo.class);
