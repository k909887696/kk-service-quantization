...
public class SMS4 {
	...
	* */
	public static void main(String[] args) {
		String allEncStr = "543432423432423";
		//加密方法测试
		String encrypt = encrypt(allEncStr);
	 ...
	 * key必须是16的整数倍
	 */
	private static final String KEY = "55G364338HLwPk9X";
	...
	public static String decrypt(String value) {
		return DecryptString(value, getKeyString());
	}
