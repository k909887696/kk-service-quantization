 ...
 * @since 2023-05-19
 */
@Tag(name = "/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/index_daily",description = "指数日线行情")
@ResponseBody
@RestController
@RequestMapping("/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/index_daily")
public class IndexDailyController {
    ...
    @PostMapping("/get_index_daily_page_list")
    public ApiResult< PageResult<IndexDailyListDto> > getIndexDailyPageList(@Valid @RequestBody IndexDailyListVo vo)   {

        return new  ApiResult(indexDailyService.selectPageList(vo));
    ...
    public ApiResult<?> deleteById(@Valid @RequestBody IndexDailyDeleteVo vo)   {
        indexDailyService.deleteById(vo);
    ...
    @PostMapping("/insert")
    public ApiResult<?> insert(@Valid @RequestBody IndexDailyAddVo vo)   {
        indexDailyService.insert(vo);
        return ApiResult.SUCCESS;
    ...
    @PostMapping("/update")
    public ApiResult<?> update(@Valid @RequestBody IndexDailyEditVo vo)   {
        indexDailyService.update(vo);
        return ApiResult.SUCCESS;
    ...
    public ApiResult< IndexDailyDto > getDetails(@Valid @RequestBody IndexDailyDetailsVo vo)   {

        return new  ApiResult(indexDailyService.selectById(vo));
