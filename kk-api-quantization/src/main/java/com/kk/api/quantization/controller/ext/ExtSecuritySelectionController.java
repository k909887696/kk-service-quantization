 ...
 * @since 2026-06-02
 */
@Tag(name = "/"+ ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixSign + "/v1/ExtSecuritySelection",description = "个人自选股(外部接口-签名认证)")
@RestController
@RequestMapping("/"+ ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixSign + "/v1/ExtSecuritySelection")
public class ExtSecuritySelectionController {
