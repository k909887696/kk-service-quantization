 ...
 * @since 2021-12-25
 */
 @Api(value = "/quantization/api/v1/security_selection",tags = "")
@ResponseBody
@RestController
@RequestMapping("/quantization/api/v1/security_selection")
public class SecuritySelectionController {

    @Resource
    public ISecuritySelectionService service;
    ...
    public ApiResult< PageResult<SecuritySelection> > getPageResult(@Valid @RequestBody BasePage vo)   {
