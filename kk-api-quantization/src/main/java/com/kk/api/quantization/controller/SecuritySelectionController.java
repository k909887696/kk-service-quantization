 ...
 * @since 2023-05-18
 */
@Api(value = "/quantization/api/v1/security_selection",tags = "个人自选股")
@ResponseBody
@RestController
...
public class SecuritySelectionController {
    ...
    @PostMapping("/get_security_selection_page_list")
    public ApiResult< PageResult<SecuritySelectionListDto> > getSecuritySelectionPageList(@Valid @RequestBody SecuritySelectionListVo vo)   {

        return new  ApiResult(securitySelectionService.selectPageList(vo));
    ...
    public ApiResult<?> deleteById(@Valid @RequestBody SecuritySelectionDeleteVo vo)   {
        securitySelectionService.deleteById(vo);
    ...
    @PostMapping("/insert")
    public ApiResult<?> insert(@Valid @RequestBody SecuritySelectionAddVo vo)   {
        securitySelectionService.insert(vo);
        return ApiResult.SUCCESS;
    ...
    @PostMapping("/update")
    public ApiResult<?> update(@Valid @RequestBody SecuritySelectionEditVo vo)   {
        securitySelectionService.update(vo);
        return ApiResult.SUCCESS;
    ...
    public ApiResult< SecuritySelectionDto > getDetails(@Valid @RequestBody SecuritySelectionDetailsVo vo)   {

        return new  ApiResult(securitySelectionService.selectById(vo));
