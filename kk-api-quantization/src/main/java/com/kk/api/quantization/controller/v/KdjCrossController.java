 ...
 * @since 2023-05-18
 */
@Tag(name = "/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/kdj_cross",description = "kdj交叉点")
@ResponseBody
@RestController
@RequestMapping("/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/kdj_cross")
public class KdjCrossController {
    ...
    @PostMapping("/get_kdj_cross_page_list")
    public ApiResult< PageResult<KdjCrossListDto> > getKdjCrossPageList(@Valid @RequestBody KdjCrossListVo vo)   {

        return new  ApiResult(kdjCrossService.selectPageList(vo));
    ...
    public ApiResult<?> deleteById(@Valid @RequestBody KdjCrossDeleteVo vo)   {
        kdjCrossService.deleteById(vo);
    ...
    @PostMapping("/insert")
    public ApiResult<?> insert(@Valid @RequestBody KdjCrossAddVo vo)   {
        kdjCrossService.insert(vo);
        return ApiResult.SUCCESS;
    ...
    @PostMapping("/update")
    public ApiResult<?> update(@Valid @RequestBody KdjCrossEditVo vo)   {
        kdjCrossService.update(vo);
        return ApiResult.SUCCESS;
    ...
    public ApiResult< KdjCrossDto > getDetails(@Valid @RequestBody KdjCrossDetailsVo vo)   {

        return new  ApiResult(kdjCrossService.selectById(vo));
