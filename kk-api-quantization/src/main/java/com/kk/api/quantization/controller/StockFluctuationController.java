 ...
 * @since 2021-12-25
 */
 @Api(value = "/quantization/api/v1/stock_fluctuation",tags = "股票异动信息")
@ResponseBody
@RestController
...
public class StockFluctuationController {
    ...
    @Resource
    public IStockFluctuationService service;
    ...
    public ApiResult< PageResult<StockFluctuation> > getPageResult(@Valid @RequestBody BasePage vo)   {
