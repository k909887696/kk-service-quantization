 ...
 * @since 2023-05-18
 */
@Tag(name = "/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/index_classify",description = "申万行业分类")
@ResponseBody
@RestController
@RequestMapping("/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/index_classify")
public class IndexClassifyController {
    ...
    @PostMapping("/get_index_classify_page_list")
    public ApiResult< PageResult<IndexClassifyListDto> > getIndexClassifyPageList(@Valid @RequestBody IndexClassifyListVo vo)   {

        return new  ApiResult(indexClassifyService.selectPageList(vo));
    ...
    public ApiResult<?> deleteById(@Valid @RequestBody IndexClassifyDeleteVo vo)   {
        indexClassifyService.deleteById(vo);
    ...
    @PostMapping("/insert")
    public ApiResult<?> insert(@Valid @RequestBody IndexClassifyAddVo vo)   {
        indexClassifyService.insert(vo);
        return ApiResult.SUCCESS;
    ...
    @PostMapping("/update")
    public ApiResult<?> update(@Valid @RequestBody IndexClassifyEditVo vo)   {
        indexClassifyService.update(vo);
        return ApiResult.SUCCESS;
    ...
    public ApiResult< IndexClassifyDto > getDetails(@Valid @RequestBody IndexClassifyDetailsVo vo)   {

        return new  ApiResult(indexClassifyService.selectById(vo));
