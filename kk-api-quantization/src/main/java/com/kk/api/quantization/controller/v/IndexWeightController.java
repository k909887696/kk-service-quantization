 ...
 * @since 2023-05-19
 */
@Tag(name = "/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/index_weight",description = "指数成分权重")
@ResponseBody
@RestController
@RequestMapping("/"+ServiceSystemKey.ServiceName+"/"+SystemKey.ApiPrefixLogin+"/v1/index_weight")
public class IndexWeightController {
    ...
    @PostMapping("/get_index_weight_page_list")
    public ApiResult< PageResult<IndexWeightListDto> > getIndexWeightPageList(@Valid @RequestBody IndexWeightListVo vo)   {

        return new  ApiResult(indexWeightService.selectPageList(vo));
    ...
    public ApiResult<?> deleteById(@Valid @RequestBody IndexWeightDeleteVo vo)   {
        indexWeightService.deleteById(vo);
    ...
    @PostMapping("/insert")
    public ApiResult<?> insert(@Valid @RequestBody IndexWeightAddVo vo)   {
        indexWeightService.insert(vo);
        return ApiResult.SUCCESS;
    ...
    @PostMapping("/update")
    public ApiResult<?> update(@Valid @RequestBody IndexWeightEditVo vo)   {
        indexWeightService.update(vo);
        return ApiResult.SUCCESS;
    ...
    public ApiResult< IndexWeightDto > getDetails(@Valid @RequestBody IndexWeightDetailsVo vo)   {

        return new  ApiResult(indexWeightService.selectById(vo));
