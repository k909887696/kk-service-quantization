...
public class StockBasicController {
    ...
    @Resource
    public IStockBasicService service;
    ...
    @PostMapping("/get_stock_basic_page_result")
    public ApiResult< PageResult<StockBasic> > getPageResult(@Valid @RequestBody BasePage vo)   {

        return new  ApiResult(service.getStockBasicPageResult(vo));
