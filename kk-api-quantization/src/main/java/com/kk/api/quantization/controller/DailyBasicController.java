...
public class DailyBasicController {
    ...
    @Resource
    public IDailyBasicService service;
    ...
    @PostMapping("/get_daily_basic_page_result")
    public ApiResult< PageResult<DailyBasic> > getDailyBasicPageResult(@Valid @RequestBody BasePage vo)   {

        return new  ApiResult(service.getDailyBasicPageResult(vo));
